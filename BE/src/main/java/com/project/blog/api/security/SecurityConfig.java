...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_READ_ENDPOINTS = { "/tags", "/profiles", "/profiles/*", "/articles",
	    "/articles/*", "/articles/**" };
	...
	http.csrf(AbstractHttpConfigurer::disable)
		...
		.authorizeHttpRequests(authorize -> authorize.requestMatchers(HttpMethod.POST, PUBLIC_WRITE_ENDPOINTS)
			.permitAll().requestMatchers(HttpMethod.GET, PUBLIC_READ_ENDPOINTS).permitAll().anyRequest()
			.authenticated())
